...
<body>
  ...
  <div class="m-auto" style="width: 80%">
    <form action="shop_check.php?s_id=<?= $_GET['s_id'] ?>" method="POST" enctype="multipart/form-data">
      <p class="m-0">購入店舗</p>
      <?= $store_data['store_name'] ?>
      <p class="m-0">ペットのお名前</p>
      <input type="text" name="p_name">
      <p class="m-0">※まだ決まっていない場合は、登録後に変更できますので空欄で構いません</p>
      <div class="d-flex">
        <div>
          <p class="m-0">犬種</p>
          <input class="w-75" type="text" name="d_type">
        </div>
        <div>
          <p class="m-0">猫種</p>
          <input class="w-75" type="text" name="c_type">
        </div>
      </div>
